...
from flask_login import UserMixin#Flask_Login
...
class User(UserMixin, db.Model):
    ...
    last_seen = db.Column(db.DateTime, default=datetime.utcnow)#час останніх відвідин на сайті
    ...
    def is_following(self, user):
        """Провіряє чи є зв'язок між двома користувачами в таблиці followed"""
...
class Post(SearchableMixin, db.Model):
    ...
    """New class 'Post' will represents posts wich were written by ussers"""
