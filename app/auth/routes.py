...
from app.auth.forms import LoginForm, RegistrationForm, ResetPasswordRequestForm, ResetPasswordForm, AcceptOrderForm
...
def accept_order():
    ...
    return render_template('auth/accept_order.html', title='Реєстрація',  form=form)
...
def reset_password(token):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('auth.login'))
    return render_template('auth/reset_password.html', form=form, title='Ресетування паролю')
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('auth.login'))
    return render_template('auth/reset_password_request.html', title='Запит на ресетування паролю'
        , form=form)
